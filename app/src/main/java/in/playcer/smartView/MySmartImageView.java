...
public class MySmartImageView extends ImageView {
   ...
   /* public void setImageContact(long contactId) {
            ...
            public void onComplete(Bitmap bitmap) {
                if(bitmap != null) {
                	try {
                		...
                		//setImageBitmap(Utility.getRoundCornerBitmap(bitmap,8));
                   ...
                   // }
                    //setImageBitmap(Utility.getRoundCornerBitmap(BitmapFactory.decodeResource(getContext().getResources(), R.drawable.stub), 1));
                }
	...
	public void setImageUrl(String bannerURL, View mLoading) {
		setImage(new WebImage(bannerURL, mLoading));
	}
}