...
public class NewsListData {
    ...
    public NewsListData(int _newsID, String _newsType, String _newsSlug, String _newsUrl, String _newsTitle, String _newsContent, String _newsExcerpt, String _newsModifiedTime,String _newsThumbnail, int isOpened) {
        this.newsID = _newsID;
