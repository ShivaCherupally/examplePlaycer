...
import in.playcer.R;
import in.playcer.ui.fragments.QuickPayFragment;
import in.playcer.ui.fragments.ResultFragment;
import in.playcer.ui.fragments.WalletScreenFragment;
...
public class CitrusUIActivity extends BaseActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VALUE_FROM_EVENTS_OR_SLOTS = getIntent().getStringExtra(CitrusFlowManager.KEY_FROM_EVENTS_OR_SLOTS);
        ...
        citrusClient.isUserSignedIn(new Callback<Boolean>() {
            ...
            public void success(Boolean success) {
                if(success){
                    ...
                    fragmentManager.beginTransaction().replace(R.id.container,new WalletScreenFragment()).addToBackStack(null).commit();
...
//        setActionBarTitle(UIConstants.SCREEN_RESULT);
        ...
        navigateTo(ResultFragment.newInstance(result, resultModel, VALUE_FROM_EVENTS_OR_SLOTS),UIConstants.SCREEN_RESULT);
    }
        ...
        if(cashoutInfo!=null){
            ...
            CitrusClient.getInstance(CitrusUIActivity.this).cashout(cashoutInfo, new Callback<PaymentResponse>() {
                ...
                public void success(PaymentResponse paymentResponse) {
                    ...
                    processAndShowResult(new ResultModel(paymentResponse,null, true));
                }
